package com.dastanapps.dastanlib.CustomUI.captcha;
...
public class TextCaptcha extends Captcha {
    ...
    public TextCaptcha(int wordLength, TextOptions opt) {
        init(0, 0, wordLength, opt);
    }

    public TextCaptcha(int width, int height, int wordLength, TextOptions opt) {
        init(width, height, wordLength, opt);
    }

    private void init(int width, int height, int wordLength, TextOptions opt) {
        setHeight(height);
        setWidth(width);
        this.options = opt;
